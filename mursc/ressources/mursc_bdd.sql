...
--
-- Client :  127.0.0.1
-- Généré le :  Mer 03 Décembre 2014 à 21:50
...
('934caf16f1c15a5ea6c1519619cf51f3', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; WOW64; rv:33.0) Gecko/20100101 Firefox/33.0', 1417610437, 'a:8:{s:9:"user_data";s:0:"";s:5:"email";s:16:"mail@yopmail.com";s:12:"is_logged_in";i:1;s:7:"user_id";i:2;s:10:"project_id";s:2:"17";s:9:"my_status";s:15:"project manager";s:11:"my_relation";s:6:"member";s:12:"project_type";s:6:"public";}');
...
--
-- Contraintes pour la table `mursc_table_gantt`
--
ALTER TABLE `mursc_table_gantt`
ADD CONSTRAINT `mursc_table_gantt_ibfk_1` FOREIGN KEY (`project_id`) REFERENCES `mursc_projects` (`id`);
